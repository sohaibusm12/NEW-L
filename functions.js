...
async function playsongyes(client, message, queue, song) {
  try {
    let embed1 = new Discord.MessageEmbed()
      ...
      .setColor(config.colors.yes)
      .setTitle("<a:MUSIC:931955213424799764> Playing Song!")
      .setDescription(`Song: [\`${song.name}\`](${song.url})`)
      .addField("`<a:cro:932025761525825566> ʀᴇǫᴜᴇsᴛᴇᴅ ʙʏ:", `>>> ${song.user}`, true)
      .addField(
        "<a:a_:932025009738768384> ᴅᴜʀᴀᴛɪᴏɴ:",
        `>>> \`${queue.formattedCurrentTime} / ${song.formattedDuration}\``,
        true
      )
      .addField(
        "<a:LOD:931955214074933258> ǫᴜᴇᴜᴇ:",
        `>>> \`${queue.songs.length} song(s) - ${queue.formattedDuration}\``,
        true
      )
      .addField("<a:mus:932027451826135051> ᴠᴏʟᴜᴍᴇ:", `>>> \`${queue.volume} %\``, true)
      .addField("<a:yy:932029749092573235> ᴠɪᴇᴡs:", `>>> \`${song.views.toLocaleString()}\``, true)
      .addField(
        "<a:wq:932031975550775366>ʟᴏᴏᴘ:",
        `>>> ${
          queue.repeatMode
            ? queue.repeatMode === 2
              ? "<a:t_:932037012356218911>Queue"
              : "<a:t_:932037012356218911>Song"
            : "<:1_:932044916933165057>"
        }`,
        true
      )
      .addField("<a:ww:932030059122921482>ᴀᴜᴛᴏᴘʟᴀʏ:", `>>> ${queue.autoplay ? "<a:t_:932037012356218911>" : "<:1_:932044916933165057>"}`, true)
.addField("<a:fi:932028914145034280> ғɪʟᴛᴇʀ:", `>>> \`${queue.filter || "<:1_:932044916933165057>"}\``, true)
      .setFooter("Made By ! sᴏʜᴀɪʙ")
      .setAuthor(
        message.author.tag,
...
function curembed(client, message) {
  try {
    ...
    embed = new Discord.MessageEmbed()
      ...
      .addField("🔊 ᴠᴏʟᴜᴍᴇ:", `>>> \`${queue.volume} %\``, true)
      .addField(
        "<a:wq:932031975550775366>ʟᴏᴏᴘ:",
        `>>> ${
          queue.repeatMode
