...
module.exports = {
  ...
  run: async (client, message, args) => {
    if (message.member.guild.owner.id !== message.author.id) return functions.embedbuilder(client, "null", message, config.colors.no, "RESET", `<a:NO:931955213303160913> You don\'t have permission for this Command! *Only the Server-Owner*`)
